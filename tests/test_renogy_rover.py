...
@pytest.mark.parametrize(
    ...
    [
        ...
        (0x0110, 2, RenogyRoverController.max_discharging_power_today, 105),
        (0x0111, 2, RenogyRoverController.charging_amphours_today, 170),
        (0x0112, 2, RenogyRoverController.discharging_amphours_today, 12),
        (0x0113, 2, RenogyRoverController.power_generation_today, 1.345),
        ...
        (0x011C, 4, RenogyRoverController.cumulative_power_generation, 1717.0947),
        (0x011E, 4, RenogyRoverController.cumulative_power_consumption, 3388.2372),
